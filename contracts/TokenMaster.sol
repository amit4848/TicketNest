...
contract TokenMaster is ERC721 {
    ...
    mapping(uint256 => mapping(uint256 => address)) public seatTaken; // {Occasion_id ,{seat_no , seat_belong_to}}
    mapping(uint256 => uint256[]) seatsTaken; // track which seat is taken
